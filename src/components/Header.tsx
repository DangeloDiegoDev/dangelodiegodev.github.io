...
const Header = () => {
    ...
    return <nav className="w-full h-[56px] fixed top-0 z-10 text-white flex justify-between py-4 px-10">
        ...
        <svg onClick={handleHamburgerMenu} className="icon icon-tabler icon-tabler-menu-2 md:hidden cursor-pointer" width="24" height="24" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M4 6l16 0" /><path d="M4 12l16 0" /><path d="M4 18l16 0" /></svg>
        <div ref={hamburgerMenu} className="hidden fixed right-0 top-14 select-none px-2 backdrop-blur-[10px]" style={{ background: "rgba(17, 24, 39, 0.9)" }}>
            <ul className="gap-10 md:hidden text-center">
                {links.map((e, index) => (
